...
const BgSlider = () => {
  ...
  return (
    <div>
      <h1 className="text-center mb-12 sm:mb-20 text-2xl md:text-3xl lg:text-4xl mt-5 font-semibold bg-gradient-to-r from-gray-900 to-gray-400  py-5 bg-clip-text text-transparent">Remove Background With High <br/> Quality and Accuracy</h1>
